...
import { Chapter, Lesson, QuizQuestion } from "@prisma/client";
import { Select, SelectContent, SelectTrigger, SelectValue , SelectItem, SelectGroup } from "@/components/ui/select";

interface QuestionLessonFormProps {
  initialData: {lesson : Lesson | null} ,
...
export const QuestionLessonForm = ({
  ...
  quizId , 
  allLessons
}: QuestionLessonFormProps) => {
  const [selectedLesson , setSelectedLesson ] = useState<Lesson | null>(initialData.lesson )
