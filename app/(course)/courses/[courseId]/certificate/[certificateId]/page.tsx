      ...
      >
        <div className="h-full flex-[.9] flex flex-col justify-center px-12 pt-2 pb-12 mb-12 space-y-4">
          ...
          <div>
            ...
            <p className="text-2xl text-sky-700 font-light">Congratulations,</p>
          </div>
          <div>
            <p className="text-3xl text-sky-700 font-bold">Joseph John</p>
            <p className="text-xl text-sky-700">has Successfully completed</p>
          </div>
          <div>
            ...
            <p className="text-xl text-sky-700">
              completed on the{" "}
              <span className="font-semibold">15th of January, 2023</span>
            </p>
          </div>
